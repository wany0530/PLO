			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-3 text-gray-800">FAQ 등록</h1>
					</div>

					<!-- card -->
					<div class="card shadow mb-4 w-50">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold" style="color: #ff8533;">FAQ 등록</h6>
						</div>
						...
						<div class="card-body pb-0">
							...
							<div class="input-group mb-3">
								...
								aria-describedby="inputGroup-sizing-default" placeholder="제목을 입력하세요." name="f_title">
							</div>
							<select name="fc_no">
							</select>
	...
	<script>
		...
		if(regCheck == 'true'){
			if(confirm("등록이 완료되었습니다. \n조회페이지로 이동하시겠습니까?"))
				location.href="${path}/faqManager";
		}
		
		// 등록
		$('.regBtn').on('click', function(){
			var f_title = $('[name=f_title]').val();
			var f_content = $('[name=f_content]').val();
