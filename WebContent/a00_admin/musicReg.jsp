			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-3 text-gray-800">음원 등록</h1>
					</div>

					<!-- card -->
					<div class="card shadow mb-4 w-25">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold" style="color: #ff8533;">음원 등록</h6>
						</div>
						...
						<div class="card-body pb-0">
							...
							<div class="input-group mb-3">
								<span class="input-group-text w-30 d-block" id="inputGroup-sizing-default">음원명</span>
								<input type="text" class="inId form-control" aria-label="Sizing example input" 
								aria-describedby="inputGroup-sizing-default" placeholder="음원명을 입력하세요." name="m_name">
							</div>
							
							<div class="input-group mb-3">
								<span class="input-group-text w-30 text-center d-block" id="inputGroup-sizing-default">재생수</span>
								<input type="text" class="inId form-control" aria-label="Sizing example input" 
								aria-describedby="inputGroup-sizing-default" placeholder="0" name="m_playnum">
							</div>
							
							<div class="input-group mb-3">
								<span class="input-group-text w-30 text-center d-block" id="inputGroup-sizing-default">파일경로</span>
								<input type="text" class="inName form-control" aria-label="Sizing example input"
								aria-describedby="inputGroup-sizing-default" placeholder="경로를 입력하세요." name="m_path">
							</div>
							
							<div class="input-group mb-3">
								<span class="input-group-text w-30 text-center d-block" id="inputGroup-sizing-default">가사</span>
								<input type="text" class="inMail form-control" aria-label="Sizing example input"
							  	aria-describedby="inputGroup-sizing-default" placeholder="가사를 입력하세요." name="m_lyrics">
							</div>
							<select name="alb_no">
	...
	<script>
		...
		if(regCheck == 'true'){
			if(confirm("등록이 완료되었습니다. \n조회페이지로 이동하시겠습니까?"))
				location.href="${path}/musicManager";
		}
		
		// 등록
		$('.regBtn').on('click', function(){
			var m_name = $('[name=m_name]').val();
			var m_playnum = $('[name=m_playnum]').val();
			var m_path = $('[name=m_path]').val();
			var m_lyrics = $('[name=m_lyrics]').val();
